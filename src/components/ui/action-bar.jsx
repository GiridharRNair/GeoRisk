...
export const ActionBarContent = forwardRef(function ActionBarContent(props, ref) {
...
export const ActionBarCloseTrigger = forwardRef(function ActionBarCloseTrigger(props, ref) {
    return (
