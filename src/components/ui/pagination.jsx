...
export const PaginationEllipsis = forwardRef(function PaginationEllipsis(props, ref) {
...
export const PaginationPrevTrigger = forwardRef(function PaginationPrevTrigger(props, ref) {
    const { size, variantMap, getHref } = useRootProps();
...
export const PaginationNextTrigger = forwardRef(function PaginationNextTrigger(props, ref) {
    const { size, variantMap, getHref } = useRootProps();
