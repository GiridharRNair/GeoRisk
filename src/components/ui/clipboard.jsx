...
export const ClipboardLabel = forwardRef(function ClipboardLabel(props, ref) {
    return <ChakraClipboard.Label textStyle="sm" fontWeight="medium" display="inline-block" mb="1" {...props} ref={ref} />;
});
...
export const ClipboardInput = forwardRef(function ClipboardInputElement(props, ref) {
    return (
